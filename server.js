...
// Source: ECDC threat assessment 12 May. 11 cases / 9 confirmed / 2 probable /
// 3 deaths. ECDC tends to be slightly more current than WHO DON updates.
// Crew status: 25 crew + 2 RIVM medics remain aboard MV Hondius en route
// to Vlissingen, Netherlands for deep-cleaning. No passengers remain on board.
const OUTBREAK_TOTALS = {
  confirmed:    9,    // PCR-positive (ECDC 12 May)
  probable:     2,    // probable / symptomatic awaiting labs (ECDC 12 May)
  deaths:       3,    // 2 Dutch, 1 German
  cases:        11,   // confirmed + probable (ECDC total) — kept for backwards-compat
  onBoard:      27,   // 25 crew + 2 RIVM medics, en route Vlissingen
  attackRate:   '~7%', // 11 confirmed/probable of ~150 original passengers/crew
...
const globalCaseData = {
  ...
  USA:                { cases: 2, deaths: 0, confirmed: 1, suspected: 1, strain: 'Andes', role: 'repat',
                        note: '16 Americans at UNMC, Omaha — 1 PCR-positive in biocontainment, 15 in quarantine for 42 days. 2 more at Emory University Hospital, Atlanta. Plane-contact monitoring: 2 King County (WA) residents who sat near an ill passenger on a flight; New Jersey and Maryland also monitoring residents. AZ/CA/GA/TX/VA monitoring earlier disembarkees. No symptomatic cases outside UNMC.' },
  France:             { cases: 1, deaths: 0, confirmed: 1, suspected: 0, strain: 'Andes', role: 'repat',
                        note: 'French passenger who disembarked 10 May developed symptoms in-flight, tested positive 11 May. Now in "very critical condition" per French health minister. Isolated at Bichat Hospital, Paris with 8 monitored contacts (4 already tested negative).' },
