...
// WHO's definition — PCR-positive — and surface the wider monitoring
// population as a separate "suspected" stat that the frontend renders
// in its own cell.
//
// Last updated: 12 May 2026.
// Source: WHO briefing 11 May (Olivier le Polain). 9 cases / 7 confirmed /
// 2 probable / 3 deaths. Some outlets cite 11 (Spanish health minister) by
// adding 2 more probables. We use WHO's number.
// Crew status: 25 crew + 2 RIVM medics remain aboard MV Hondius en route
// to Rotterdam for deep-cleaning. No passengers remain on board.
const OUTBREAK_TOTALS = {
  confirmed:    7,    // PCR-positive (WHO)
  probable:     2,    // probable / symptomatic awaiting labs (WHO)
  deaths:       3,    // 2 Dutch, 1 German
  cases:        9,    // confirmed + probable (WHO total) — kept for backwards-compat
  onBoard:      27,   // 25 crew + 2 RIVM medics, en route Rotterdam
  attackRate:   '~6%', // 9 confirmed/probable of ~150 original passengers/crew
...
const globalCaseData = {
  ...
  Switzerland:        { cases: 1, deaths: 0, confirmed: 1, suspected: 0, strain: 'Andes', role: 'repat',
                        note: 'One hospitalized passenger; sequence shared with Pathoplexus (ANDV/Switzerland/Hu-3337/2026).' },
  USA:                { cases: 2, deaths: 0, confirmed: 1, suspected: 1, strain: 'Andes', role: 'repat',
                        note: '16 Americans at University of Nebraska Medical Center (UNMC) — 1 PCR-positive in biocontainment, 15 in quarantine unit. 2 more at Emory University Hospital, Atlanta. 9 disembarked-earlier passengers monitored by AZ/CA/GA/TX/VA health depts. NJ and MD also monitoring residents who shared flights with infected passengers (no symptoms).' },
  France:             { cases: 1, deaths: 0, confirmed: 1, suspected: 0, strain: 'Andes', role: 'repat',
                        note: 'French passenger who disembarked 10 May tested positive 11 May, condition worsening. 8 contacts isolated at Bichat Hospital, Paris.' },
  Australia:          { cases: 5, deaths: 0, confirmed: 0, suspected: 5, strain: 'Andes', role: 'repat',
                        note: '5 Australian passengers aboard. Landed Netherlands 12 May after a delayed direct flight from Tenerife; repatriation home expected this week per Health Minister Mark Butler. None symptomatic at time of disembarkation.' },
  'New Zealand':      { cases: 1, deaths: 0, confirmed: 0, suspected: 1, strain: 'Andes', role: 'repat',
                        note: '1 New Zealander aboard, returning home this week alongside the Australian passengers.' },
...
const coordinates = {
  ...
  Australia:          { lat: -33.8688, lng: 151.2093 },  // Sydney (typical entry point)
