...
const OUTBREAK_TOTALS = {
  cases:        8,    // 6 confirmed + 2 suspected (WHO DON599 + Tedros 7 May)
  deaths:       3,
  confirmed:    6,
  suspected:    2,
  onBoard:     147,   // people remaining on the ship en route to Tenerife
  attackRate:  '~5%', // 8 cases of ~150 original passengers/crew
...
const globalCaseData = {
  ...
  'Tristan da Cunha': { cases: 1, deaths: 1, confirmed: 1, suspected: 0, strain: 'Andes', role: 'port',
                        note: 'First passenger died aboard 11 April; likely exposure region.' },
  'Saint Helena':     { cases: 2, deaths: 1, confirmed: 1, suspected: 1, strain: 'Andes', role: 'port',
                        note: 'Body offloaded 24 April; 30 passengers disembarked; second death airlifted to Johannesburg.' },
  ...
  'Canary Islands':   { cases: 0, deaths: 0, confirmed: 0, suspected: 0, strain: 'Andes', role: 'port',
                        note: 'Tenerife arrival 10 May for passenger disembarkation and repatriation.' },

  // — Countries receiving evacuated / repatriated patients —
  Netherlands:        { cases: 3, deaths: 0, confirmed: 2, suspected: 1, strain: 'Andes', role: 'repat',
                        note: 'Three evacuated 6 May, including ship\'s doctor.' },
  ...
  'South Africa':     { cases: 2, deaths: 1, confirmed: 1, suspected: 1, strain: 'Andes', role: 'repat',
                        note: 'Two patients in Johannesburg; one death (26 April). Contact tracing of 62 people.' },
  UK:                 { cases: 1, deaths: 0, confirmed: 0, suspected: 1, strain: 'Andes', role: 'repat',
                        note: 'British passenger transferred to Johannesburg; UKHSA contact-tracing 30 disembarked travellers.' },
  Spain:              { cases: 0, deaths: 0, confirmed: 0, suspected: 0, strain: 'Andes', role: 'repat',
                        note: 'Repatriation hub; quarantine for Spanish citizens at military base in Madrid.' },
  Switzerland:        { cases: 1, deaths: 0, confirmed: 1, suspected: 0, strain: 'Andes', role: 'repat',
                        note: 'One hospitalized passenger.' },
  Argentina:          { cases: 0, deaths: 0, confirmed: 0, suspected: 0, strain: 'Andes', role: 'origin',
                        note: 'Ship departed Ushuaia 1 April. Andes virus is endemic in Patagonia.' }
};
...
const coordinates = {
  ...
  // Repatriation destinations — country center is fine
  Netherlands:        { lat:  52.1326, lng:   5.2913 },
  Germany:            { lat:  51.1657, lng:  10.4515 },
  'South Africa':     { lat: -26.2041, lng:  28.0473 },  // Johannesburg specifically
  UK:                 { lat:  55.3781, lng:  -3.4360 },
  Spain:              { lat:  40.4168, lng:  -3.7038 },  // Madrid (quarantine site)
