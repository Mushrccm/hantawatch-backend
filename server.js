...
// Source reconciliation note: ABC7 reports 10 confirmed+probable as of
// disembarkation; Wikipedia and Tedros 11 May briefing count 11 after the
// French national and second American tested positive overnight. We use 11
// since it's the more recent figure. Update OUTBREAK_TOTALS and per-location
// data as new briefings publish.
...
const globalCaseData = {
  ...
  USA:                { cases: 2, deaths: 0, confirmed: 1, suspected: 1, strain: 'Andes', role: 'repat',
                        note: '16 Americans at University of Nebraska Medical Center (UNMC) since 10 May — 1 asymptomatic PCR-positive in biocontainment, 1 mildly symptomatic, 14 in quarantine. 2 more flown to Atlanta. California monitoring 4 residents (3 ship-connected, 1 plane contact). AZ/GA/VA/TX also monitoring.' },
  France:             { cases: 1, deaths: 0, confirmed: 1, suspected: 0, strain: 'Andes', role: 'repat',
                        note: 'French national tested positive overnight 11 May, condition worsening. 8 contacts isolated at Bichat Hospital, Paris.' },
  Argentina:          { cases: 0, deaths: 0, confirmed: 0, suspected: 0, strain: 'Andes', role: 'origin',
                        note: 'Ship departed Ushuaia 1 April. Argentine health ministry reconstructing the Dutch couple\'s route through Patagonia and the Argentine/Chilean border crossings (since 27 November) to identify exposure source. No Ushuaia cases in recent decades.' }
};
