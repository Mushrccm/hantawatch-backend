...
// Source reconciliation note: WHO official count (Olivier le Polain, 11 May
// briefing) is 9 cases / 7 confirmed / 3 deaths. ABC News and Spanish health
// minister cite 11 confirmed+probable. We currently keep 11 here as the
// upper-bound user-facing count but acknowledge WHO's stricter 9. Update
// OUTBREAK_TOTALS and per-location data as new briefings publish.
...
const OUTBREAK_TOTALS = {
  cases:        11,   // confirmed + probable
  deaths:       3,    // 2 Dutch (Dutch couple), 1 German woman
  confirmed:    8,    // PCR-confirmed
  suspected:    3,    // probable / symptomatic awaiting confirmation
